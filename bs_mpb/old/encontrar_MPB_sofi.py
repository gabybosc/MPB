...
from funciones import Bpara_Bperp, fechas, hdec_to_UTC
...
day = int(input("sólo el day en DD \n"))
year = 2015
month = 3
date_orbit = dt.datetime(year, month, day)
...
with open("outputs/grupo1.txt", "a") as file:
    file.write(f"{year}-{month}-{day}" + "\t" + f"{hdec_to_UTC(val)}")
    file.write("\n")
