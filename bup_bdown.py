...
from funciones import error, find_nearest, find_nearest_final, find_nearest_inicial, datenum
...
datos = np.loadtxt(path + 'MAG_1s/2016/mvn_mag_l2_2016076ss1s_20160316_v01_r01.sts', skiprows=148) #lee todo y me da todo
n =2
