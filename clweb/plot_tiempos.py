...
sys.path.append("..")
from funciones import find_nearest, Bpara_Bperp, tiempos, datenum


"""
Con los tiempos t1 t2 t3 t4 ploteo los datos de MAG, SWEA, SWIA y LPW.
Les dibujo encima líneas que correspondan a los tiempos.
