...
from funciones import find_nearest, deltaB, unix_to_decimal, datenum, Bpara_Bperp, fechas, tiempos, UTC_to_hdec
...
fig = plt.figure(1, figsize=(20,10))#Lo bueno de esta forma es que puedo hacer que solo algunos compartan eje
...
axz1.axvspan(xmin = tiempo_mag[tm_up][0], xmax = tiempo_mag[tm1][0], facecolor = '#581845', alpha = 0.5)
axz1.axvspan(xmin = tiempo_mag[tmva][0], xmax = tiempo_mag[tm4][0], facecolor = '#FFC300', alpha = 0.75)
axz1.axvspan(xmin = tiempo_mag[tm4][0], xmax = tiempo_mag[tm_down][0], facecolor = '#C70039', alpha = 0.5)

axz2.axvspan(xmin = tiempo_mag[tm_up][0], xmax = tiempo_mag[tm1][0], facecolor = '#581845', alpha = 0.5, label = 'Upstream')
axz2.axvspan(xmin = tiempo_mag[tmva][0], xmax = tiempo_mag[tm4][0], facecolor = '#FFC300', alpha = 0.75, label = 'MVA')
axz2.axvspan(xmin = tiempo_mag[tm4][0], xmax = tiempo_mag[tm_down][0], facecolor = '#C70039', alpha = 0.5, label = 'Downstream')
...
def regiones(ax, tiempo_mag, tm1, tm4, tm_up, tm_down, tbs, tmpr):
    ax.axvspan(xmin = tiempo_mag[tbs][0], xmax = tiempo_mag[tm1][0], facecolor = '#FE6779', alpha = 0.6) #Magnetosheath
    ax.axvspan(xmin = tiempo_mag[tm1][0], xmax = tiempo_mag[tm4][0], facecolor = '#79B953', alpha = 0.6) #MPB
    ax.axvspan(xmin = tiempo_mag[tm4][0], xmax = tiempo_mag[tmpr][0], facecolor = '#428AE0', alpha = 0.5) #MPR
...
ax5.axvspan(xmin = tiempo_mag[tbs][0], xmax = tiempo_mag[tm1][0], facecolor = '#FE6779', alpha = 0.6, label = 'Magnetosheath')
ax5.axvspan(xmin = tiempo_mag[tm1][0], xmax = tiempo_mag[tm4][0], facecolor = '#79B953', alpha = 0.6, label = 'MPB')
ax5.axvspan(xmin = tiempo_mag[tm4][0], xmax = tiempo_mag[tmpr][0], facecolor = '#428AE0', alpha = 0.5, label = 'MPR')
