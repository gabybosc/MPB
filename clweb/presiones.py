...
def importar_swica(year, month, day, ti, tf):
    ...
    #
    # return swica, t_cut, d_cut, vel_cut, vel_norm_cut
...
ti_MPR = float(hoja_parametros.cell(fila, 9).value)
tf_MPR = ti_MPR + 0.15
normal = [
...
mag, t_mag, B_mag, posicion = importar_mag(year, month, day, ti_sw, tf_MPR)
...
fin_mpr_mag = donde(t_mag, ti_MPR + 0.015)
