...
fig1 = plt.figure(3)#Lo bueno de esta forma es que puedo hacer que solo algunos compartan eje
...
for xc in [t1]:#,tiempo_mag[t2]]:#,tiempo_mag[t3]]:#,tiempo_mag[t4]]:
    plt.axvline(x = xc, color = 'k', linewidth=1.5)
# axz1.axvspan(xmin = datetime(2016,3,16,18,12), xmax = datetime(2016,3,16,18,13), facecolor = 'green', alpha = 0.2)
# axz1.axvspan(xmin = datetime(2016,3,16,18,14,51), xmax = datetime(2016,3,16,18,15,52), facecolor = 'purple', alpha = 0.2)
...
for xc in [t1]:#,tiempo_mag[t2]]:#,tiempo_mag[t3]]:#,tiempo_mag[t4]]:
    plt.axvline(x = xc, color = 'k', linewidth=1.5)
# axz2.axvspan(xmin = datetime(2016,3,16,18,12), xmax = datetime(2016,3,16,18,13), facecolor = 'green', alpha = 0.2)
# axz2.axvspan(xmin = datetime(2016,3,16,18,14,51), xmax = datetime(2016,3,16,18,15,52), facecolor = 'purple', alpha = 0.2)
plt.grid()
plt.ylabel('|B| (nT)')
...
for xc in [t1]:#,tiempo_mag[t2]]:#,tiempo_mag[t3]]:#,tiempo_mag[t4]]:
    plt.axvline(x = xc, color = 'k', linewidth=1.5)
# axz3.axvspan(xmin = datetime(2016,3,16,18,12), xmax = datetime(2016,3,16,18,13), facecolor = 'green', alpha = 0.2)
# axz3.axvspan(xmin = datetime(2016,3,16,18,14,51), xmax = datetime(2016,3,16,18,15,52), facecolor = 'purple', alpha = 0.2)
...
# axz4.axvspan(xmin = datetime(2016,3,16,18,12), xmax = datetime(2016,3,16,18,13), facecolor = 'green', alpha = 0.2)
# axz4.axvspan(xmin = datetime(2016,3,16,18,14,51), xmax = datetime(2016,3,16,18,15,52), facecolor = 'purple', alpha = 0.2)
axz4.grid()
...
for xc in [t1]:#,tiempo_mag[t2]]:#,tiempo_mag[t3]]:#,tiempo_mag[t4]]:
    plt.axvline(x = xc, color = 'k', linewidth=1.5)
# axz5.axvspan(xmin = datetime(2016,3,16,18,12), xmax = datetime(2016,3,16,18,13), facecolor = 'green', alpha = 0.2, label = 'Upstream')
# axz5.axvspan(xmin = datetime(2016,3,16,18,14,51), xmax = datetime(2016,3,16,18,15,52), facecolor = 'purple', alpha = 0.2, label = 'Downstream')
axz5.set_ylabel('Densidad de p+ \n del SW (cm⁻³)')
axz5.set_xlabel('Tiempo (UTC)')
axz5.grid()
...
fig4 = plt.figure(4)#Lo bueno de esta forma es que puedo hacer que solo algunos compartan eje
fig4.subplots_adjust(top = 0.95, bottom = 0.1, left = 0.10,right=0.95, hspace = 0.005, wspace=0.15)
plt.xticks( rotation=25 )
xfmt = md.DateFormatter('%H:%M')
...
fig5 = plt.figure(5)#Lo bueno de esta forma es que puedo hacer que solo algunos compartan eje
fig5.subplots_adjust(top = 0.95, bottom = 0.1, left = 0.10,right=0.95, hspace = 0.005, wspace=0.15)
plt.xticks( rotation=25 )
xfmt = md.DateFormatter('%H:%M')
...
fig6 = plt.figure(6)#Lo bueno de esta forma es que puedo hacer que solo algunos compartan eje
fig6.subplots_adjust(top = 0.95, bottom = 0.1, left = 0.10,right=0.95, hspace = 0.005, wspace=0.15)
plt.xticks( rotation=25 )
xfmt = md.DateFormatter('%H:%M')
