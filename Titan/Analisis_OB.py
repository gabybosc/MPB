...
t_low = np.load("../../../datos/Titan/t_low.npy")  # para la posicion
tiempo = np.load("../../../datos/Titan/tiempo.npy")
t_hires = np.load("../../../datos/Titan/t_hires.npy")  # para el B
t_plot = np.load("../../../datos/Titan/t_plot.npy")  # para Bpara Bperp
